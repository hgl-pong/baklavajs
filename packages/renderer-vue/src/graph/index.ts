...
import { registerSelectAllNodesCommand } from "./selectAllNodes.command";
...
export function registerGraphCommands(displayedGraph: Ref<Graph>, handler: ICommandHandler, switchGraph: SwitchGraph) {
    ...
    registerSelectAllNodesCommand(displayedGraph, handler);
...
export type { SelectAllNodesCommand } from "./selectAllNodes.command";
...
export { SELECT_ALL_NODES_COMMAND } from "./selectAllNodes.command";
